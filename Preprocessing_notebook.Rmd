...
```{r, eval = TRUE, echo=FALSE}
knitr::include_graphics("figures/overview_Sox10_Tubb3.png")
```
...
```
```{r, eval = TRUE, echo=FALSE}
knitr::include_graphics("figures/cell_selection.png")
```
...
saveRDS(p2w,"output/p2w_sensory.rds")
p2w$serializeToStaticFast("output/p2w_sensory.bin")
```

Download processed data for reproducibility
...
```
```{r, eval = TRUE, echo=FALSE}
knitr::include_graphics("figures/main_umap_plots.png")
```
...
```{r, eval = TRUE, echo=FALSE}
knitr::include_graphics("figures/adhesion.png")
```
...
knitr::include_graphics("figures/migration.png")
```